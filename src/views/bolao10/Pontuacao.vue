                            ...
                            <table class="table table-responsive font-tabela-peq">
                                ...
                                <tbody>
                                    <tr v-for="(pontuacao, index) in listaPontuacao" :key="pontuacao.usuario.id"
                                        ...
                                        <td v-show="idSituacao>1" class="borderFase"> <el-tooltip :content="pontuacao.apostaColocacao.artilharia.nome" placement="top"><img width="20" :src="pontuacao.apostaColocacao.artilharia.imagem"></el-tooltip> <span v-if="colocacao.artilharia != null"> ({{ pontuacao.apostaColocacao.pontosArtilharia }}) </span></td>
                                        <td v-show="idSituacao>1"> <el-tooltip :content="pontuacao.apostaColocacao.quarto.nome" placement="top"><img width="20" :src="pontuacao.apostaColocacao.quarto.imagem"></el-tooltip> <span v-if="colocacao.quarto != null"> ({{ pontuacao.apostaColocacao.pontosQuarto }}) </span></td>
                                        <td v-show="idSituacao>1" class="fundoTerceiro"> <el-tooltip :content="pontuacao.apostaColocacao.terceiro.nome" placement="top"><img width="20" :src="pontuacao.apostaColocacao.terceiro.imagem"></el-tooltip> <span v-if="colocacao.terceiro != null"> ({{ pontuacao.apostaColocacao.pontosTerceiro }}) </span></td>
                                        <td v-show="idSituacao>1" class="fundoVice"> <el-tooltip :content="pontuacao.apostaColocacao.vice.nome" placement="top"><img width="20" :src="pontuacao.apostaColocacao.vice.imagem"></el-tooltip> <span v-if="colocacao.vice != null"> ({{ pontuacao.apostaColocacao.pontosVice }}) </span></td>
                                        <td v-show="idSituacao>1" class="fundoCampeao"> <el-tooltip :content="pontuacao.apostaColocacao.campeao.nome" placement="top"><img width="20" :src="pontuacao.apostaColocacao.campeao.imagem"></el-tooltip> <span v-if="colocacao.campeao != null"> ({{ pontuacao.apostaColocacao.pontosCampeao }}) </span></td>
